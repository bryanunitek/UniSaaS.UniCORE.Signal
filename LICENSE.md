...
All UniCORE-authored **source code** additions in this repository are licensed under **AGPL-3.0**, matching the upstream codebase licence. This is required by the copyleft terms of the upstream licence — derivative works must carry the same licence. AGPL-3.0 additionally requires that modified versions offered as a network service must make their complete source code available to users of that service.
